...
## Raspberry Pi
* If your TV cannot detect the Raspberry Pi's CEC, or if the the Pi can't detect the TV, try adding the following line in `/boot/firmware/config.txt` and reboot the Pi: `hdmi_force_hotplug=1`
